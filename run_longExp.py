...
import torch
from exp.Exp_CDN import Exp_CDN
import random
import numpy as np
...
# AMD-specific hyperparameters (for AMD backbone under HDN/models)
parser.add_argument(
    '--amd_n_block',
    type=int,
    default=1,
    help='AMD: number of DDI blocks',
)
parser.add_argument(
    '--amd_alpha',
    type=float,
    default=0.0,
    help='AMD: strength of channel-wise FFN refinement',
)
parser.add_argument(
    '--amd_mix_layer_num',
    type=int,
    default=3,
    help='AMD: number of multi-scale mixing layers (MDM.k)',
)
parser.add_argument(
    '--amd_mix_layer_scale',
    type=int,
    default=2,
    help='AMD: scale factor between multi-scale mixing layers (MDM.c)',
)
parser.add_argument(
    '--amd_patch',
    type=int,
    default=16,
    help='AMD: patch length used in DDI',
)
parser.add_argument(
    '--amd_layernorm',
    type=bool,
    default=True,
    help='AMD: whether to use BatchNorm-based layer normalization',
)
parser.add_argument(
    '--amd_dropout',
    type=float,
    default=0.1,
    help='AMD: dropout rate',
)
# Formers 
...
parser.add_argument('--no_local', type=bool, default=False, help='no local decomposition')
